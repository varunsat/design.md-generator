---
name: design-md
description: Generate or update a DESIGN.md (Google Stitch open format) for a web project. Trigger when the user asks to "create design.md", "generate design system file", "update design.md", "bootstrap a design system from this codebase", or similar. Also trigger when editing or auditing an existing DESIGN.md.
---
...
Engage this skill whenever the user asks to:
